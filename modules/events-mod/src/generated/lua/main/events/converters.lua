...
local ChunkSize = ____kafkatorio_2Dschema.ChunkSize
local FactorioEntityStatus = ____kafkatorio_2Dschema.FactorioEntityStatus
local MinedProduct = ____kafkatorio_2Dschema.MinedProduct
____exports.Converters = {}
local Converters = ____exports.Converters
do
    local EntityStatusRecord
    ...
    function Converters.entityPosition(position)
        return {position.x, position.y}
    end
    function Converters.chunkPosition(position)
    ...
    function Converters.collisionBox(collision_box)
        return {
            leftTop = ____exports.Converters.entityPosition(collision_box.left_top),
            rightBottom = ____exports.Converters.entityPosition(collision_box.right_bottom)
        }
    end
    EntityStatusRecord = {
