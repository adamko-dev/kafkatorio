...
//  )
  ...
  when (outputFilename) {
    null -> println(definitions)
      ...
      outPath.resolve("kafkatorio-schema.ts").writeText(
        """
        ┆$kt2tsHeader
        ┆
        ┆$typedFactorioImports
        ┆
        ┆$definitions
        """.trimMargin("┆")
      )
...
@Language("TypeScript")
private val kt2tsHeader = """
  |// Generated by kxs-ts-gen - do not edit this file manually
  """.trimMargin()

@Language("text")
private val typedFactorioImports = """
  |import {int, PlayerIndex, SurfaceIndex, uint, UnitNumber} from "factorio:runtime";
  |import {double, float, int8, uint8} from "factorio:prototype";
  """.trimMargin()
