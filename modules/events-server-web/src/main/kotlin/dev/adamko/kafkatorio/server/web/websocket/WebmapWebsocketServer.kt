...
import dev.adamko.kafkatorio.server.processor.topology.WebsocketBroadcaster
...
class WebmapWebsocketServer : WebsocketBroadcaster {
  ...
  override suspend fun sendMessageToClients(message: String) {
    log("sending message to clients: $message")
    messagesToClients.emit(message)
  }
