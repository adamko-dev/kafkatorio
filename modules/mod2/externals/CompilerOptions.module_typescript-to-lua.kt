...
external var isBundleEnabled: (options: OmitIndexSignature<CompilerOptions> /* OmitIndexSignature<ts.CompilerOptions> & `T$0` */) -> Boolean

external fun validateOptions(options: OmitIndexSignature<CompilerOptions> /* OmitIndexSignature<ts.CompilerOptions> & `T$0` */): Array<Diagnostic>