...
external interface Identifier : PrimaryExpression, Declaration {
    var text: String
    var escapedText: dynamic /* String & `T$8` | Unit & `T$8` | InternalSymbolName */
        get() = definedExternally
        set(value) = definedExternally
...
external interface QualifiedName : Node {
    var left: dynamic /* Identifier | QualifiedName */
        get() = definedExternally
        set(value) = definedExternally
...
external interface NamedDeclaration : Declaration {
    var name: dynamic /* Identifier? | PrivateIdentifier? | StringLiteral? | NoSubstitutionTemplateLiteral? | NumericLiteral? | ComputedPropertyName? | ElementAccessExpression? | ObjectBindingPattern? | ArrayBindingPattern? | PropertyAccessEntityNameExpression? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface ComputedPropertyName : Node {
    override var parent: Declaration
...
external interface SignatureDeclarationBase : NamedDeclaration, JSDocContainer {
    override var name: dynamic /* Identifier? | StringLiteral? | NumericLiteral? | ComputedPropertyName? | PrivateIdentifier? */
        get() = definedExternally
        set(value) = definedExternally
...
external interface VariableDeclaration : NamedDeclaration, JSDocContainer {
    override var parent: dynamic /* VariableDeclarationList | CatchClause */
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | ObjectBindingPattern | ArrayBindingPattern */
        get() = definedExternally
        set(value) = definedExternally
...
external interface VariableDeclarationList : Node {
    override var parent: dynamic /* VariableStatement | ForStatement | ForOfStatement | ForInStatement */
        get() = definedExternally
        set(value) = definedExternally
...
external interface BindingElement : NamedDeclaration {
    override var parent: dynamic /* ObjectBindingPattern | ArrayBindingPattern */
        get() = definedExternally
        set(value) = definedExternally
    var propertyName: dynamic /* Identifier? | StringLiteral? | NumericLiteral? | ComputedPropertyName? | PrivateIdentifier? */
        get() = definedExternally
        set(value) = definedExternally
    var dotDotDotToken: DotDotDotToken?
        get() = definedExternally
...
external interface PropertySignature : TypeElement, JSDocContainer {
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
        set(value) = definedExternally
    override var questionToken: QuestionToken?
        get() = definedExternally
        set(value) = definedExternally
    var type: TypeNode?
        get() = definedExternally
...
external interface PropertyDeclaration : ClassElement, JSDocContainer {
    override var parent: dynamic /* ClassDeclaration | ClassExpression */
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
...
external interface PropertyAssignment : ObjectLiteralElement, JSDocContainer {
    override var parent: ObjectLiteralExpression
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
        set(value) = definedExternally
    var questionToken: QuestionToken?
...
external interface ObjectBindingPattern : Node {
    override var parent: dynamic /* VariableDeclaration | ParameterDeclaration | BindingElement */
        get() = definedExternally
        set(value) = definedExternally
...
external interface ArrayBindingPattern : Node {
    override var parent: dynamic /* VariableDeclaration | ParameterDeclaration | BindingElement */
        get() = definedExternally
        set(value) = definedExternally
    var elements: NodeArray<dynamic /* BindingElement | OmittedExpression */>
}
...
external interface FunctionLikeDeclarationBase : SignatureDeclarationBase {
    ...
    var exclamationToken: ExclamationToken?
        get() = definedExternally
        set(value) = definedExternally
    var body: dynamic /* Block? | Expression? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface MethodSignature : SignatureDeclarationBase, TypeElement {
    override var kind: Any
    override var parent: dynamic /* ClassDeclaration | ClassExpression | InterfaceDeclaration | TypeLiteralNode */
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
...
external interface MethodDeclaration : FunctionLikeDeclarationBase, ClassElement, ObjectLiteralElement, JSDocContainer {
    override var kind: Any
    override var parent: dynamic /* ClassDeclaration | ClassExpression | ObjectLiteralExpression */
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
...
external interface GetAccessorDeclaration : FunctionLikeDeclarationBase, ClassElement, TypeElement, ObjectLiteralElement, JSDocContainer {
    override var kind: Any
    override var parent: dynamic /* ClassDeclaration | ClassExpression | ObjectLiteralExpression | TypeLiteralNode | InterfaceDeclaration */
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
...
external interface ImportTypeNode : NodeWithTypeArguments {
    ...
    var argument: TypeNode
    var qualifier: dynamic /* Identifier? | QualifiedName? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface FunctionOrConstructorTypeNodeBase : TypeNode, SignatureDeclarationBase {
    override var kind: dynamic /* SyntaxKind.FunctionType | SyntaxKind.ConstructorType */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface TypePredicateNode : TypeNode {
    override var parent: dynamic /* CallSignatureDeclaration | ConstructSignatureDeclaration | MethodSignature | IndexSignatureDeclaration | FunctionTypeNode | ConstructorTypeNode | JSDocFunctionType | FunctionDeclaration | MethodDeclaration | ConstructorDeclaration | GetAccessorDeclaration | SetAccessorDeclaration | FunctionExpression | ArrowFunction | JSDocTypeExpression */
        get() = definedExternally
        set(value) = definedExternally
    var assertsModifier: AssertsToken?
        get() = definedExternally
        set(value) = definedExternally
...
external interface TupleTypeNode : TypeNode {
    var elements: NodeArray<dynamic /* TypeNode | NamedTupleMember */>
}

external interface NamedTupleMember : TypeNode, JSDocContainer, Declaration {
    var dotDotDotToken: Token<SyntaxKind.DotDotDotToken>?
        get() = definedExternally
        set(value) = definedExternally
    var name: Identifier
...
external interface TypeOperatorNode : TypeNode {
    var operator: dynamic /* SyntaxKind.KeyOfKeyword | SyntaxKind.UniqueKeyword | SyntaxKind.ReadonlyKeyword */
        get() = definedExternally
        set(value) = definedExternally
    var type: TypeNode
}
...
external interface MappedTypeNode : TypeNode, Declaration {
    var readonlyToken: dynamic /* ReadonlyToken? | PlusToken? | MinusToken? */
        get() = definedExternally
        set(value) = definedExternally
    var typeParameter: TypeParameterDeclaration
    var nameType: TypeNode?
        get() = definedExternally
        set(value) = definedExternally
    var questionToken: dynamic /* QuestionToken? | PlusToken? | MinusToken? */
        get() = definedExternally
        set(value) = definedExternally
    var type: TypeNode?
        get() = definedExternally
...
external interface LiteralTypeNode : TypeNode {
    var literal: dynamic /* NullLiteral | TrueLiteral | FalseLiteral | LiteralExpression | PrefixUnaryExpression */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface TemplateLiteralTypeNode : TypeNode {
    ...
    var templateSpans: NodeArray<TemplateLiteralTypeSpan>
}

external interface TemplateLiteralTypeSpan : TypeNode {
    override var parent: TemplateLiteralTypeNode
    var type: TypeNode
...
external interface SyntheticExpression : Expression {
    ...
    var type: Type
    var tupleNameSource: dynamic /* ParameterDeclaration? | NamedTupleMember? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface ArrowFunction : Expression, FunctionLikeDeclarationBase, JSDocContainer {
    ...
    override var body: dynamic /* FunctionBody | Expression */
        get() = definedExternally
        set(value) = definedExternally
...
external interface TemplateHead : TemplateLiteralLikeNode {
    override var parent: dynamic /* TemplateExpression | TemplateLiteralTypeNode */
        get() = definedExternally
        set(value) = definedExternally
}

external interface TemplateMiddle : TemplateLiteralLikeNode {
    override var parent: dynamic /* TemplateSpan | TemplateLiteralTypeSpan */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface TemplateSpan : Node {
    override var parent: TemplateExpression
    var expression: Expression
    var literal: dynamic /* TemplateMiddle | TemplateTail */
        get() = definedExternally
        set(value) = definedExternally
...
external interface SpreadElement : Expression {
    override var parent: dynamic /* ArrayLiteralExpression | CallExpression | NewExpression */
        get() = definedExternally
        set(value) = definedExternally
    var expression: Expression
}
...
external interface PropertyAccessExpression : MemberExpression, NamedDeclaration {
    ...
    var questionDotToken: QuestionDotToken?
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | PrivateIdentifier */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface ImportCall : CallExpression {
    override var expression: ImportExpression
}

external interface ExpressionWithTypeArguments : NodeWithTypeArguments {
    override var parent: dynamic /* HeritageClause | JSDocAugmentsTag | JSDocImplementsTag */
        get() = definedExternally
        set(value) = definedExternally
    var expression: LeftHandSideExpression
}
...
external interface MetaProperty : PrimaryExpression {
    var keywordToken: dynamic /* SyntaxKind.NewKeyword | SyntaxKind.ImportKeyword */
        get() = definedExternally
        set(value) = definedExternally
    var name: Identifier
}
...
external interface JsxElement : PrimaryExpression {
    ...
    var children: NodeArray<dynamic /* JsxText | JsxExpression | JsxElement | JsxSelfClosingElement | JsxFragment */>
    var closingElement: JsxClosingElement
}

external interface JsxTagNamePropertyAccess : PropertyAccessExpression {
    override var expression: dynamic /* Identifier | ThisExpression | JsxTagNamePropertyAccess */
        get() = definedExternally
        set(value) = definedExternally
}

external interface JsxAttributes : ObjectLiteralExpressionBase<dynamic /* JsxAttribute | JsxSpreadAttribute */> {
    override var parent: dynamic /* JsxSelfClosingElement | JsxOpeningElement */
        get() = definedExternally
        set(value) = definedExternally
}

external interface JsxOpeningElement : Expression {
    override var parent: JsxElement
    var tagName: dynamic /* Identifier | ThisExpression | JsxTagNamePropertyAccess */
        get() = definedExternally
        set(value) = definedExternally
    var typeArguments: NodeArray<TypeNode>?
        get() = definedExternally
...
external interface JsxOpeningFragment : Expression {
    override var parent: JsxFragment
}
...
external interface JsxAttribute : ObjectLiteralElement {
    override var parent: JsxAttributes
    override var name: Identifier
    var initializer: dynamic /* StringLiteral? | JsxExpression? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface JsxExpression : Expression {
    override var parent: dynamic /* JsxElement | JsxAttribute | JsxSpreadAttribute */
        get() = definedExternally
        set(value) = definedExternally
    var dotDotDotToken: Token<SyntaxKind.DotDotDotToken>?
        get() = definedExternally
...
external interface JsxText : LiteralLikeNode {
    override var parent: JsxElement
    var containsOnlyTriviaWhiteSpaces: Boolean
}
...
external interface ForOfStatement : IterationStatement {
    var awaitModifier: AwaitKeywordToken?
        get() = definedExternally
        set(value) = definedExternally
    var initializer: dynamic /* VariableDeclarationList | Expression */
        get() = definedExternally
...
external interface CaseBlock : Node {
    override var parent: SwitchStatement
    var clauses: NodeArray<dynamic /* CaseClause | DefaultClause */>
}

external interface CaseClause : Node {
    override var parent: CaseBlock
    var expression: Expression
    var statements: NodeArray<Statement>
}
...
external interface CatchClause : Node {
    override var parent: TryStatement
...
external interface ClassLikeDeclarationBase : NamedDeclaration, JSDocContainer {
    override var kind: dynamic /* SyntaxKind.ClassDeclaration | SyntaxKind.ClassExpression */
        get() = definedExternally
        set(value) = definedExternally
    override var name: Identifier?
        get() = definedExternally
...
external interface HeritageClause : Node {
    override var parent: dynamic /* InterfaceDeclaration | ClassDeclaration | ClassExpression */
        get() = definedExternally
        set(value) = definedExternally
...
external interface EnumMember : NamedDeclaration, JSDocContainer {
    override var parent: EnumDeclaration
    override var name: dynamic /* Identifier | StringLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier */
        get() = definedExternally
        set(value) = definedExternally
    var initializer: Expression?
...
external interface ModuleDeclaration : DeclarationStatement, JSDocContainer {
    override var parent: dynamic /* ModuleBlock | NamespaceDeclaration | Identifier | JSDocNamespaceDeclaration | SourceFile */
        get() = definedExternally
        set(value) = definedExternally
    override var name: dynamic /* Identifier | StringLiteral */
        get() = definedExternally
        set(value) = definedExternally
    var body: dynamic /* ModuleBlock? | NamespaceDeclaration? | Identifier? | JSDocNamespaceDeclaration? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface ModuleBlock : Node, Statement {
    override var parent: ModuleDeclaration
    var statements: NodeArray<Statement>
}

external interface ImportEqualsDeclaration : DeclarationStatement, JSDocContainer {
    override var parent: dynamic /* SourceFile | ModuleBlock */
        get() = definedExternally
        set(value) = definedExternally
    override var name: Identifier
...
external interface ExternalModuleReference : Node {
    override var parent: ImportEqualsDeclaration
    var expression: Expression
}
...
external interface ImportClause : NamedDeclaration {
    override var parent: ImportDeclaration
    var isTypeOnly: Boolean
    override var name: Identifier?
        get() = definedExternally
        set(value) = definedExternally
    var namedBindings: dynamic /* NamespaceImport? | NamedImports? */
        get() = definedExternally
        set(value) = definedExternally
}

external interface NamespaceImport : NamedDeclaration {
    override var parent: ImportClause
    override var name: Identifier
}

external interface NamespaceExport : NamedDeclaration {
    override var parent: ExportDeclaration
    override var name: Identifier
}
...
external interface ExportDeclaration : DeclarationStatement, JSDocContainer {
    override var parent: dynamic /* SourceFile | ModuleBlock */
        ...
        set(value) = definedExternally
    var isTypeOnly: Boolean
    var exportClause: dynamic /* NamespaceExport? | NamedExports? */
        get() = definedExternally
        set(value) = definedExternally
    var moduleSpecifier: Expression?
        get() = definedExternally
...
external interface ImportSpecifier : NamedDeclaration {
    override var parent: NamedImports
...
external interface ExportSpecifier : NamedDeclaration {
    override var parent: NamedExports
    var propertyName: Identifier?
        get() = definedExternally
        set(value) = definedExternally
    override var name: Identifier
...
external interface ExportAssignment : DeclarationStatement, JSDocContainer {
    override var parent: SourceFile
...
external interface JSDocNameReference : Node {
    var name: dynamic /* Identifier | QualifiedName | JSDocMemberName */
        get() = definedExternally
        set(value) = definedExternally
}

external interface JSDocMemberName : Node {
    var left: dynamic /* Identifier | QualifiedName | JSDocMemberName */
        get() = definedExternally
        set(value) = definedExternally
    var right: Identifier
}
...
external interface `T$21` {
    var expression: dynamic /* Identifier | PropertyAccessEntityNameExpression */
        get() = definedExternally
        set(value) = definedExternally
}

external interface JSDocAugmentsTag : JSDocTag {
    var `class`: ExpressionWithTypeArguments /* ExpressionWithTypeArguments & `T$21` */
}
...
external interface JSDocTypedefTag : JSDocTag, NamedDeclaration {
    override var parent: JSDoc
    var fullName: dynamic /* JSDocNamespaceDeclaration? | Identifier? */
        get() = definedExternally
        set(value) = definedExternally
    override var name: Identifier?
        get() = definedExternally
        set(value) = definedExternally
    var typeExpression: dynamic /* JSDocTypeExpression? | JSDocTypeLiteral? */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface JSDocCallbackTag : JSDocTag, NamedDeclaration {
    ...
    override var name: Identifier?
        get() = definedExternally
        set(value) = definedExternally
    var typeExpression: JSDocSignature
}

external interface JSDocSignature : JSDocType, Declaration {
    var typeParameters: Array<JSDocTemplateTag>?
        get() = definedExternally
        set(value) = definedExternally
    var parameters: Array<JSDocParameterTag>
    var type: JSDocReturnTag?
}
...
external interface JSDocTypeLiteral : JSDocType {
    var jsDocPropertyTags: Array<JSDocPropertyLikeTag>?
        get() = definedExternally
        set(value) = definedExternally
    var isArrayType: Boolean
}
...
external interface Bundle : Node {
    var prepends: Array<dynamic /* InputFiles | UnparsedSource */>
...
external interface UnparsedSource : Node {
    var fileName: String
    var text: String
    var prologues: Array<UnparsedPrologue>
    ...
    var sourceMapText: String?
        get() = definedExternally
        set(value) = definedExternally
    var syntheticReferences: Array<UnparsedSyntheticReference>?
        get() = definedExternally
        set(value) = definedExternally
    var texts: Array<dynamic /* UnparsedPrepend | UnparsedTextLike */>
}

external interface UnparsedSection : Node {
    override var kind: SyntaxKind
    override var parent: UnparsedSource
    var data: String?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface UnparsedPrepend : UnparsedSection {
    override var parent: UnparsedSource
    var texts: Array<UnparsedTextLike>
}

external interface UnparsedTextLike : UnparsedSection {
    override var kind: dynamic /* SyntaxKind.UnparsedText | SyntaxKind.UnparsedInternalText */
        get() = definedExternally
        set(value) = definedExternally
    override var parent: UnparsedSource
}
...
external interface JsonSourceFile : SourceFile {
    override var statements: NodeArray<JsonObjectExpressionStatement>
}
...
external interface JsonMinusNumericLiteral : PrefixUnaryExpression {
    override var kind: Any
    override var operator: Any
    override var operand: NumericLiteral
}

external interface JsonObjectExpressionStatement : ExpressionStatement {
    override var expression: dynamic /* ObjectLiteralExpression | ArrayLiteralExpression | JsonMinusNumericLiteral | NumericLiteral | StringLiteral | TrueLiteral | FalseLiteral | NullLiteral */
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface EmitHelperBase {
    var name: String
    var scoped: Boolean
    var text: dynamic /* String | (node: EmitHelperUniqueNameCallback) -> String */
        get() = definedExternally
        set(value) = definedExternally
    var priority: Number?
        get() = definedExternally
        set(value) = definedExternally
    var dependencies: Array<dynamic /* ScopedEmitHelper | UnscopedEmitHelper */>?
        get() = definedExternally
        set(value) = definedExternally
}

external interface ScopedEmitHelper : EmitHelperBase {
    override var scoped: Boolean
}
...
external interface UserPreferences {
    var disableSuggestions: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var quotePreference: String? /* "auto" | "double" | "single" */
        get() = definedExternally
        set(value) = definedExternally
    var includeCompletionsForModuleExports: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeCompletionsForImportStatements: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeCompletionsWithSnippetText: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeAutomaticOptionalChainCompletions: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeCompletionsWithInsertText: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var allowIncompleteCompletions: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var importModuleSpecifierPreference: String? /* "shortest" | "project-relative" | "relative" | "non-relative" */
        get() = definedExternally
        set(value) = definedExternally
    var importModuleSpecifierEnding: String? /* "auto" | "minimal" | "index" | "js" */
        get() = definedExternally
        set(value) = definedExternally
    var allowTextChangesInNewFiles: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var providePrefixAndSuffixTextForRename: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includePackageJsonAutoImports: String? /* "auto" | "on" | "off" */
        get() = definedExternally
        set(value) = definedExternally
    var provideRefactorNotApplicableReason: Boolean?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface InvalidatedProjectBase {
    var kind: InvalidatedProjectKind
    var project: String /* String & `T$5` */
...
external interface InlayHintsOptions : UserPreferences {
    var includeInlayParameterNameHints: String? /* "none" | "literals" | "all" */
        get() = definedExternally
        set(value) = definedExternally
    var includeInlayParameterNameHintsWhenArgumentMatchesName: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeInlayFunctionParameterTypeHints: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeInlayVariableTypeHints: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeInlayPropertyDeclarationTypeHints: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeInlayFunctionLikeReturnTypeHints: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var includeInlayEnumMemberValueHints: Boolean?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface FormatCodeSettings : EditorSettings {
    ...
    var insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var insertSpaceAfterOpeningAndBeforeClosingEmptyBraces: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces: Boolean?
        get() = definedExternally
    ...
    var insertSpaceBeforeTypeAnnotation: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var indentMultiLineObjectLiteralBeginningOnBlankLine: Boolean?
        get() = definedExternally
        set(value) = definedExternally
    var semicolons: SemicolonPreference?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface RenameInfoOptions {
    var allowRenameOfImportPath: Boolean?
        get() = definedExternally
        set(value) = definedExternally
}

external interface DocCommentTemplateOptions {
    var generateReturnInDocTemplate: Boolean?
        get() = definedExternally
        set(value) = definedExternally
}
...
external var createNodeArray: (elements: Array<T>?, hasTrailingComma: Boolean?) -> NodeArray<T>
...
external var createToken: (kind: TKind) -> Token<TKind>
...
external var getMutableClone: (node: T) -> T
