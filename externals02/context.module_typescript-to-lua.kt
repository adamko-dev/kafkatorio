...
external open class TransformationContext(program: Program, sourceFile: SourceFile, visitorMap: VisitorMap) {
    ...
    open val diagnostics: Array<Diagnostic>
    open val checker: DiagnosticsProducingTypeChecker
    open val resolver: EmitResolver
    open val options: dynamic /* typealias OmitIndexSignature = dynamic */
    open val luaTarget: LuaTarget
    open val isModule: Boolean
